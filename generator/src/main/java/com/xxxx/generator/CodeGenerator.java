...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setPassword("qq199912221255");
        ...
        // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意xml 的名称会跟着发生变化！！
        ...
        //数据库表字段映射到实体的命名策略
        strategy.setColumnNaming(NamingStrategy.no_change/*字段没有驼峰命名所以不用改变*/);
        //lombok模型   自动生成lombok注解
        strategy.setEntityLombokModel(true);
        //生成 @RestController 控制器   因为是前后端分离的项目所以返回给前端的基本上都是字符串
